...
beautiful.init("~/.config/awesome/darktheme.lua")
...
awful.screen.connect_for_each_screen(function(s)
    ...
    -- Create the wibox
    s.mywibox = awful.wibar({ position = "bottom", screen = s, border_width = 0, height = 30 })
	...
	{ -- Left widgets
	    ...
	    bar_spr,
            weather_widget{
              api_key='884ab641a938b66181fcc6cdca41bcac',
              coordinates = {39.7073, 2.79173},
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey,  }, "l", function () awful.util.spawn("xtrlock -b") end, {description = "lock screen", group = "awesome"}),
    ...
    -- Prompt
    awful.key({ modkey },            "r",     function () awful.util.spawn("rofi -show combi", false) end,
